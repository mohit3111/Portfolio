  ...
  return (
    <div>
      ...
      <div className="lefthome" >
          <div className="intro">
            <p className="p" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" >Hi, there</p>
            <div className="mohit">
              <ul className="name">
                <li data-aos="fade-up" data-aos-duration="1000" data-aos-delay="700">I'm&nbsp;&nbsp; Mohit&nbsp;&nbsp; Kansal</li>
              </ul>
            </div>
            <p className="p2" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="900">
            Creative&nbsp;&nbsp; Frontend&nbsp;&nbsp; Web Developer.
            </p>
            <p className="intro2" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1100">
